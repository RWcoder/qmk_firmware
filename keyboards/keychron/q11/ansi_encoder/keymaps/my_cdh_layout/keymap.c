...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [CONTROL] = LAYOUT_91_ansi(
        ...
        _______,  G(KC_LEFT),  WIN_SNAP,  WWW_POPOUT,  G(KC_UP),   C(KC_L),       MS_BTN4,  MS_BTN5,  KC_UP,    A(KC_TAB),  C(KC_TAB),  C(KC_BSPC),  _______,  _______,    _______,  KC_PGUP,
        _______,  VDI_MIN,     KC_ESC,    S(KC_ESC),   C(KC_S),    LSG(KC_RGHT),  C(KC_P),  KC_LEFT,  KC_DOWN,  KC_RGHT,    RCS(KC_P),  MO(CODE),    KC_BSPC,  C(KC_ENT),  KC_PGDN,
